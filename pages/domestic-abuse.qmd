...
DA_chart1 <- plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      ...
      tickmode = "array",
      tickvals = DA_chart1_data$yaxis_year[seq(1, length(DA_chart1_data$yaxis_year), by = 5)],
      ticktext = DA_chart1_data$yaxis_year[seq(1, length(DA_chart1_data$yaxis_year), by = 5)],
      showline = TRUE,
      linecolor = "#000000",
      showgrid = FALSE,
      ticks = "outside",
