...
homicide_plot <- plot_ly(homicide_age_gender, x = ~Year) %>%
  add_trace(
    ...
    text = ~paste(
      Year,
      paste0("Female <18: ", format(`Female <18`, big.mark = ",")),
      sep = "<br>"
    ),
    hoverinfo = "text",
  ...
  add_trace(
    ...
    text = ~paste(
      Year,
      paste0("Male <18: ", format(`Male <18`, big.mark = ",")),
      sep = "<br>"
    ),
    hoverinfo = "text",
    type = "scatter", mode = "lines+markers",
  ...
  add_trace(
    ...
    text = ~paste(
      Year,
      paste0("All Homicides: ", format(`All Homicides`, big.mark = ",")),
      sep = "<br>"
    ),
    hoverinfo = "text",
    type = "scatter", mode = "lines+markers",
  ...
  layout(
    margin = list(t = 60, r = 160, b = 80),   # 👈 give more room on the right
    xaxis = list(
      type = "category",
      categoryorder = "array",
      categoryarray = years,
...
div(
  ...
  p(
    ...
    a(
      ...
      "Homicide by age and gender (Table 4) (opens in a new tab)",
      target = "_blank"
    )
  )
)
