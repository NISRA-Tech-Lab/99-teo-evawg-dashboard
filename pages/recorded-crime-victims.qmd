...
tick_every_5 <- all_police_recorded_crime_victims$Year[seq(1, length(all_police_recorded_crime_victims$Year), by = 5)]
...
p(style ="margin-top: 30px;", "Please note that crimes in which the gender of the victim was unknown have not been displayed in this chart; therefore, totals may not sum to 100%.")
