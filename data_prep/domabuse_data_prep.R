...
# DA_chart2_data_URL <- "https://www.psni.police.uk/system/files/2025-05/386082373/Domestic%20Abuse%20Tables%20Period%20Ending%2031st%20March%202025.xlsx"
# temp_file <- tempfile(fileext = ".xlsx")
# 
# # Download the file using httr::GET
# GET(DA_chart2_data_URL,
...
# colnames(DA_chart2_data) <- c("category", "count")
# 
# 
# # Extract the total value
# DA_chart2_total <- DA_chart2_data$count[DA_chart2_data$category
#                                                       == "DA_chart2_total crime (domestic abuse motivation)"]
# 
# # Adding a new column for percentage values for crime recorded
# DA_chart2_data$Percentage <- round((DA_chart2_data$`Count of crime recorded`
#                                         / DA_chart2_total) * 100, )
# 
# # Replacing column values in a data frame
# DA_chart2_data$`Crime Categories`[4] <- "Stalking and Harassment"
# 
# DA_chart2_data$`Crime Categories`[2] <- "Violence with injury (including homicide and death or serious injury-unlawful driving)"
# 
# # dropping the first and last column of `DA_chart2_data`
# 
